...
.openings-under-board.game-under-board
  ...
  .openings-complete(v-if="hasFinished")
    ...
    .action-buttons
      ...
      a.blue-button(href="/openings") Play again
...
export default {
  ...
  mounted() {
    ...
    const puzzleTracking = this.setupPuzzleTrackingSubscriptions('openings', trackSolvedPuzzle)
