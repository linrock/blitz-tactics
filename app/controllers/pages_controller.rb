class PagesController < ApplicationController
  before_action :set_user, only: [:world1, :world2, :world3, :world4, :world5, :world6]
  before_action :set_homepage_puzzles, only: [:world1, :world2, :world3, :world4, :world5, :world6]
